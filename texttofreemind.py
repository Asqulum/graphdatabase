#!/usr/bin/env python
#
# A simple text to freemind conversion program from:
# https://github.com/wbolster/text-to-freemind/blob/master/text-to-freemind
...
def convert_lines_into_mm(lines, out_fp):
    ...
    tree.write(out_fp, "unicode")#, 'utf-8')
    out_fp.write('\n')
